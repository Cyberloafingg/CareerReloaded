...
positions = ['产品设计', '交互设计', '产品经理', '产品运营', '前端开发', '后端开发']

companies = ['腾讯公司', '阿里巴巴', '华为公司', '字节跳动', '网易公司']

directions = ['人机交互', '服务设计', '协同设计', '人工智能', '计算机科学']
...
def initialize():
    ...
    return city, age, gender, mbti_type, attribute, position, company, direction
...
class Person:
    ...
    def __init__(self) -> None:
        city, age, gender, mbti_type, attribute, position, company, direction = initialize()
        # self.city = city
        self.age = age
        self.gender = gender
...
if __name__ == '__main__':
    #随机生成人物
    city, age, gender, mbti_type, attribute, position, company, direction = initialize()
    print(f'city: {city}, age: {age}, gender: {gender}, mbti: {mbti_type}, position:{position}, company:{company}, direction:{direction}')
    print(f'{attribute}')
    print()
